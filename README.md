...
- 💓 **Async Health Monitor**: Non-blocking background worker that measures live latency (`ms`) and endpoint reachability.
...
| **Client Bundle Size (gzip)** | **< 28 KB** | ~45 KB | 300 KB+ | 500 KB+ |
