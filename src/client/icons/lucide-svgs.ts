/**
 * Lightweight Lucide SVG Vector Map for Homelab Categories and Fallback Icons
 * Zero external font or heavy icon-bundle runtime dependencies.
 */
...
export const SVG_ICONS: Record<string, string> = {
  ...
  activity: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.48 12H2"/></svg>`,
  ...
  bento: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="7" x="3" y="3" rx="1"/><rect width="8" height="9" x="3" y="12" rx="1"/><rect width="8" height="9" x="13" y="12" rx="1"/></svg>`,
...
/**
 * Returns clean SVG markup or folder fallback
 */
export function getSvgIcon(name?: string): string {
  if (!name) return SVG_ICONS.folder;
