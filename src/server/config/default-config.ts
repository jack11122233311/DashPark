...
# DashPark v0.2.0 Showcase Homelab Configuration
    ...
    services:
      ...
      - id: "plex"
        ...
        shortcuts:
          ...
          - name: "Activity"
            url: "http://192.168.1.100:32400/web/index.html#!/status/pms/activity"
      ...
      - id: "jellyfin"
        ...
        shortcuts:
          - name: "Dashboard"
            url: "http://192.168.1.100:8096/web/index.html#!/dashboard.html"
      ...
      - id: "sonarr"
        ...
        shortcuts:
          ...
          - name: "Queue"
            url: "http://192.168.1.100:8989/activity/queue"
      ...
      - id: "radarr"
        ...
        shortcuts:
          - name: "Queue"
            url: "http://192.168.1.100:7878/activity/queue"
          - name: "Movies"
            url: "http://192.168.1.100:7878/movies"
  ...
  - id: "infra"
    ...
    services:
      ...
      - id: "portainer"
        ...
        shortcuts:
          - name: "Containers"
            url: "https://192.168.1.10:9443/#!/1/docker/containers"
          - name: "Stacks"
            url: "https://192.168.1.10:9443/#!/1/docker/stacks"
      ...
      - id: "truenas"
        ...
        shortcuts:
          ...
          - name: "Shares"
            url: "https://192.168.1.200/sharing"
    ...
    services:
      ...
      - id: "grafana"
        ...
        shortcuts:
          ...
          - name: "Alerts"
            url: "http://192.168.1.21:3000/alerting/list"
      ...
      - id: "prometheus"
        ...
        shortcuts:
          ...
          - name: "Graph"
            url: "http://192.168.1.21:9090/graph"
